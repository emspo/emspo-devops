pipeline {
    ...
    environment {
        ...
        PROJECT_NAME = 'FE 3400'
        JENKINS_PIPELINE_NAME = 'emspo-fe-dev-3400'
    }
    ...
    stages {
        stage('Clone Repository') {
            steps {
                ...
                git credentialsId: 'github-creds-id', url: 'https://github.com/emspo/emspo-fe.git', branch: "${GIT_BRANCH}"
            }
        }
            ...
            steps {
                withCredentials([
                    ...
                    sh """
                        ...
                        cd /var/lib/jenkins/workspace/${JENKINS_PIPELINE_NAME}
                        cd docker
